      ...
      <form onSubmit={handleSubmit} className="flex gap-3 items-end">
        <div className="flex-1 relative">
          <textarea
            ...
            disabled={isLoading}
            className="w-full bg-input-bg border border-border-gray rounded-lg px-4 py-3 text-text-primary placeholder-text-secondary resize-none min-h-[44px] max-h-[200px] disabled:opacity-50 focus:outline-none focus:border-blue-500"
            rows={1}
          />
        </div>
